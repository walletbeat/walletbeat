...
import type { PrivateTransfersOutcomeMetadata } from '@/schema/attributes/privacy/private-transfers'
...
export interface PrivateTransfersDetailsProps extends EvaluationData<PrivateTransfersOutcomeMetadata> {
...
export function privateTransfersDetailsContent(
	bakedProps: Omit<
		...
		keyof EvaluationData<PrivateTransfersOutcomeMetadata>
	>,
