...
function noFeeTransparency(): Evaluation<FeeTransparencyValue> {
	return {
		value: {
			...
			shortExplanation: sentence(
				(walletMetadata: WalletMetadata) => `
					${walletMetadata.displayName} does not provide clear information about transaction fees.
				`,
			),
		...
		details: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} does not provide clear information about transaction fees
				before users confirm transactions. Users cannot easily understand how much they will pay
				in network fees or if there are any additional fees charged by the wallet.
			`,
		),
		howToImprove: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} should implement fee transparency by clearly displaying
				network fees before transaction confirmation and disclosing any additional fees charged
				by the wallet.
			`,
		),
	};
...
function basicFeeTransparency(
	...
	return {
		value: {
			...
			shortExplanation: sentence(
				(walletMetadata: WalletMetadata) => `
					${walletMetadata.displayName} provides basic information about transaction fees.
				`,
			),
		...
		details: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} provides basic information about network fees before
				transaction confirmation, but the information is limited. ${
					disclosesWalletFees
						? 'The wallet does disclose any additional fees it charges.'
						: 'The wallet does not clearly disclose if it charges any additional fees.'
				} ${
					showsTransactionPurpose
						? 'The wallet clearly shows the purpose of the transaction.'
						: 'The wallet does not clearly show the purpose of the transaction.'
				}
			`,
		),
		howToImprove: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} should improve fee transparency by providing more detailed
				breakdowns of network fees${
					!disclosesWalletFees ? ', clearly disclosing any additional wallet fees' : ''
...
function detailedFeeTransparency(
	...
	return {
		value: {
			...
			shortExplanation: sentence(
				(walletMetadata: WalletMetadata) => `
					${walletMetadata.displayName} provides detailed information about transaction fees.
				`,
			),
		...
		details: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} provides detailed information about network fees before
				transaction confirmation, including a breakdown of gas costs. ${
					disclosesWalletFees
						? 'The wallet does disclose any additional fees it charges.'
						: 'The wallet does not clearly disclose if it charges any additional fees.'
				} ${
		...
		howToImprove: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} should improve fee transparency by ${
					!disclosesWalletFees
...
function comprehensiveFeeTransparency(): Evaluation<FeeTransparencyValue> {
	return {
		value: {
			...
			shortExplanation: sentence(
				(walletMetadata: WalletMetadata) => `
					${walletMetadata.displayName} provides comprehensive information about all transaction fees.
				`,
			),
		...
		details: paragraph(
			({ wallet }) => `
				${wallet.metadata.displayName} provides comprehensive information about all fees before
				transaction confirmation. This includes a detailed breakdown of network fees, clear disclosure
				of any additional fees charged by the wallet, and a clear explanation of the transaction purpose.
...
export const feeTransparency: Attribute<FeeTransparencyValue> = {
	...
	wording: {
		...
		whatCanWalletDoAboutIts: (walletMetadata: WalletMetadata) =>
			`What can ${walletMetadata.displayName} do to improve fee transparency?`,
	},
	question: sentence(`
	...
	ratingScale: {
		...
		pass: exampleRating(
			paragraph(`
				The wallet provides comprehensive fee information, including detailed breakdowns
				of network fees, clear disclosure of any additional wallet fees, and clear
				explanation of transaction purposes.
			`),
		...
		partial: [
			exampleRating(
				paragraph(`
					The wallet provides detailed information about network fees, but may not fully
					disclose additional wallet fees or clearly show transaction purposes.
				`),
				detailedFeeTransparency(true, false).value,
			),
			exampleRating(
				paragraph(`
					The wallet provides basic information about transaction fees, but the information
					is limited and may not include a breakdown of costs.
				`),
		...
		fail: [
			exampleRating(
				paragraph(`
					The wallet does not provide clear information about transaction fees before
					users confirm transactions.
				`),
	...
	evaluate: (features: ResolvedFeatures): Evaluation<FeeTransparencyValue> => {
		...
		const { level } = feeTransparencySupport;
		const { disclosesWalletFees } = feeTransparencySupport;
		const { showsTransactionPurpose } = feeTransparencySupport;
