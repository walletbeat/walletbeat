...
export function toFullyQualified(
	...
	if (
		...
		// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion, prefer-destructuring -- Safe because we just verified the "explanation" field exists and is a string.
	...
	if (
		...
		// eslint-disable-next-line @typescript-eslint/no-unsafe-type-assertion, prefer-destructuring -- Safe because we verify the "lastRetrieved" field exists, and the only possible string type for it is CalendarDate.
