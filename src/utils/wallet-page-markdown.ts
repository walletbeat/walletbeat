...
import { hasAutoGeneratedLabel } from '@/schema/url'
					...
					if (qualifiedRefs.length > 0) {
						...
						for (const ref of qualifiedRefs) {
							for (const labeledUrl of ref.urls) {
								...
								// Auto-generated labels are identifier-like (`foo.ts L1-2
								// @abcdef1`, domain names, ...); render them as inline code.
								const label = hasAutoGeneratedLabel(labeledUrl)
									? `\`${labeledUrl.label}\``
									: labeledUrl.label
