	...
	return (
		<>
			<Typography variant='body1'>
				...
				<br />
				<strong>
					As <ExternalLink url='https://l2beat.com'>L2Beat</ExternalLink> has done for
					Ethereum Layer 2s, Walletbeat aims to do the same for Ethereum wallets.
				</strong>
			</Typography>
			<Divider
			...
			<Typography variant='body1'>
				...
				Ethereum wallets.
				<br />
				Where there is inherent subjectivity, such as in the decision of <em>which</em>{' '}
				criteria are used to rate and categorize wallets, Walletbeat aims to follow
				Ethereum&apos;s ethos and cypherpunk values as a guiding principle. See{' '}
			...
			/>
			<Typography variant='body1'>
				Walletbeat is committed to transparency. Contributors reveal their affiliation and /
				or shares in wallet companies. It is an{' '}
				<IconLink
			...
			<Typography variant='body1'>
				...
				retroactive funding, ecosystem grants, and individual donations. Walletbeat will
				then publish a funding transparency page that documents the date, origin, and amount
				of such funding.
			</Typography>
			<Divider
				orientation='horizontal'
			...
			<Typography variant='body1'>
				...
				<ExternalLink url='https://fluidkey.com/'>Fluidkey</ExternalLink>, an incorporated
				company in Switzerland with a wallet offering. In order to maximize credible
				neutrality, Walletbeat&apos;s long-term ownership goal is to become an independent
				DAO or foundation (similar to L2Beat) once Walletbeat reaches a higher level of
				maturity and a broader set of regular contributors. Until this is achieved,
				Walletbeat will not list nor rate wallet software from Fluidkey.
			</Typography>
			<Divider
				orientation='horizontal'
				variant='middle'
			...
			/>
			<Typography variant='body1'>
				Wallets listed on Walletbeat do not represent an endorsement and is for
				informational purposes only. If you find that something is wrong, please help
				Walletbeat by{' '}
				<IconLink
					IconComponent={GitHubIcon}
					href='https://github.com/walletbeat/walletbeat'
