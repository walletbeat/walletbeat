import { toFullyQualified, type ReferenceArray, type References } from '@/schema/reference'
...
export function ReferenceLinks({
	...
	references: References | ReferenceArray | undefined | null
	explanation?: string
}): React.JSX.Element {
	const qualRefs = toFullyQualified(references)
