...
- **How does your session relate to CROPS?**
  ...
  We will be directly mapping each letter of the CROPS acronym onto a set of wallet features and attributes that embody these principles for Ethereum wallets. Walletbeat aims to make CROPS legible for wallets.

- **Resources**: (See notes) https://github.com/walletbeat/walletbeat/blob/beta/resources/talks/2026-06-eth-berlin/ethereum-day/
- **60-second introduction video** (Optional): See notes section
