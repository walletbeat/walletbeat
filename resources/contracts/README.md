...
- **Transaction Simulation with Volatile State**: How wallets simulate transactions that produce different results based on changing onchain state (e.g., block number, timestamp)
