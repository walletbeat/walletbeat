...
The test covers many security and self-sovereignty attributes. Questions such as:

- Does the wallet critically rely on any centralized service?
...
Wallets that pass the Walkaway Test move closer to one of Ethereum's core values: **self-sovereignty**.

We've previously covered one component of this test, the L1 RPC Provider Independence:
