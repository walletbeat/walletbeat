...
- `WALLETBEAT_EOA` = `'WALLETBEAT_EOA'`: 0xc9C8C560BA80e840A71bE2F9409600B6133a119f: The Walletbeat staging treasury address, an externally-owned account (EOA), not a contract.
