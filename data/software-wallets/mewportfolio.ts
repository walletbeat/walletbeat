		...
		security: {
			...
			hardwareWalletSupport: {
				[Variant.BROWSER]: {
					...
					supportedWallets: {
						[HardwareWalletType.KEEPKEY]: supported({
							[HardwareWalletConnection.webUSB]: supported({
								ref: {
									explanation:
										'MyEtherWallet supports native transaction signing with KeepKey hardware wallets.',
						...
						[HardwareWalletType.OTHER]: supported({
							[HardwareWalletConnection.webUSB]: supported({
								ref: {
									explanation:
										'MyEtherWallet supports native transaction signing with BitBox02 and CoolWallet hardware wallets.',
									url: 'https://www.myetherwallet.com/',
								},
							}),
						}),
						[HardwareWalletType.LEDGER]: supported({
							[HardwareWalletConnection.webUSB]: supported({
								ref: {
									explanation:
										'MyEtherWallet supports native transaction signing with Ledger hardware wallets.',
									url: 'https://www.myetherwallet.com/',
								},
							}),
						}),
						[HardwareWalletType.TREZOR]: supported({
							[HardwareWalletConnection.webUSB]: supported({
								ref: {
									explanation:
										'MyEtherWallet supports native transaction signing with Trezor hardware wallets.',
									url: 'https://www.myetherwallet.com/',
								},
							}),
						}),
